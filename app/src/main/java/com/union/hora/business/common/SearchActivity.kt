package com.union.hora.business.common
...
import com.union.hora.adapter.SearchHistoryAdapter
...
import com.union.hora.business.common.presenter.SearchPresenter
...
class SearchActivity : BaseMvpSwipeBackActivity<SearchContract.View, SearchContract.Presenter>(), SearchContract.View {
    ...
    override fun initLayoutRes(): Int = R.layout.activity_search
