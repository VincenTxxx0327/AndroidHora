...
import com.union.common.http.BaseUrl
import com.union.common.http.GlobalHttpHandler
import com.union.common.http.imageloader.BaseImageLoaderStrategy
...
import com.union.common.integration.cache.IntelligentCache
import com.union.common.integration.cache.LruCache
import com.union.common.utils.getCacheFile
...
class GlobalConfigModule private constructor(builder: Builder) {
    ...
    private val mErrorListener: ResponseErroListener?
    ...
    @Singleton
    @Provides
    internal fun provideResponseErrorListener(): ResponseErroListener {
        return mErrorListener ?: ResponseErroListener.EMPTY
    }
    ...
    class Builder {
        ...
        var mResponseErrorListener: ResponseErroListener? = null
        ...
        fun responseErrorListener(listener: ResponseErroListener): Builder {//处理所有RxJava的onError逻辑
